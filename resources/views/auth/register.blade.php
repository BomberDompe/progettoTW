...
<div class="container">
    <div class="screenreg">
            ...
            <div style="display: inline-flex;">
                ...
                <div id="rightreg">
                    <div  class="register__field" style="display: inline-flex;">
                        ...
                        {{ Form::date('b_day','', ['class' => '', 'id' => 'nascita']) }}
                    </div>
        ...
        <div class="screen__backgroundreg">
            <span class="screen__background__shapereg screen__background__shape1reg"></span>
        </div>
    </div>
</div>
@endsection